...
public enum S3ErrorCode {
	...
	OBJECT_DOWNLOAD_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3_OBJECT_DOWNLOAD_FAILED", "S3 객체 다운로드에 실패했습니다."),
	OBJECT_UPLOAD_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3_OBJECT_UPLOAD_FAILED", "S3 객체 업로드에 실패했습니다."),
	...
	IMAGE_PROCESSING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3_IMAGE_PROCESSING_FAILED", "이미지 파생본 생성에 실패했습니다."),
